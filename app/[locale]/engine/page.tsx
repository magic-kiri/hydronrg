        ...
        <aside className='information'>
          <div className="advantages">
            <div className="advantage">
              ...
              <ul>
                <li>Повышает эффективности ДВС путем дожига несгораемого топлива. Это позволяет экономить топливо (от 10 до 40 %),</li>
                <li>Продливает жизненный цикл ДВС путем уменьшения нагара основных компонентов ДВС</li>
              </ul>
            </div>
